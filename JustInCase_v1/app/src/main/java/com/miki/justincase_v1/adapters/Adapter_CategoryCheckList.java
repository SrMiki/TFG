...
public class Adapter_CategoryCheckList extends RecyclerView.Adapter<Adapter_CategoryCheckList.AdapterViewHolder> implements View.OnClickListener {
    ...
    private Adapter_ItemCheckList adapter_item;

    private View.OnClickListener listener;
    private HandLuggage handLuggage;

    public Adapter_CategoryCheckList(ArrayList<Category> categories, HandLuggage handLuggage) {
...
//        });
        ...
        itemList = Presented.selectBaggageFromThisCategoryInThisHandLuggage(focusCategory, this.handLuggage, holder.itemView.getContext());
        ...
        adapter_item = new Adapter_ItemCheckList(itemList);
