...
public class Adapter_CountryList extends RecyclerView.Adapter<Adapter_CountryList.AdapterViewHolder> implements View.OnClickListener, Filterable {

    private View.OnClickListener listener;
    List<String> dataset;
    ArrayList<String> referencesDataset;

    public Adapter_CountryList(ArrayList<String> dataset) {
    ...
    @NonNull
    @Override
    public Adapter_CountryList.AdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Adapter_CountryList.AdapterViewHolder holder, int position) {
