...
public class Adapter_ItemCheckList extends RecyclerView.Adapter<Adapter_ItemCheckList.BaggageContentViewHolder> implements View.OnClickListener {
    ...
    public Adapter_ItemCheckList(ArrayList<Baggage> contenidoDeEstaMaleta) {
