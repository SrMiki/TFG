...
public class initDB {
    ...
    private static void initCategoryContent(ArrayList<Item> items, ArrayList<Category> categories) {
        ...
        insertCategory(items, categories, 1, 3);
        insertCategory(items, categories, 1, 4);
        insertCategory(items, categories, 1, 5);

        insertCategory(items, categories, 2, 6);
        insertCategory(items, categories, 2, 7);
        insertCategory(items, categories, 2, 8);
...
//        suitcases.add(new Suitcase("maleta grande", "azul", 80, 40,40,50));
    ...
    private static ArrayList<Category> initCategory() {
        ...
        categories.add(new Category("categoria1"));
        categories.add(new Category("otra"));
        categories.add(new Category("buenas"));
        categories.add(new Category("tardes"));
